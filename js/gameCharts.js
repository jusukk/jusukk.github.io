...
// CHARTS
// -------------------------------------------------------------------------------------------------------
const canvasChartTop5 = document.getElementById("gameChartsChart1");
const ctxChartTop5 = canvasChartTop5.getContext("2d");
let chartTop5 = null;

const canvasChartAvarage = document.getElementById("gameChartsChart2");
...
// GAME
// -------------------------------------------------------------------------------------------------------
const canvasGame = document.getElementById("gameChartsGame");
